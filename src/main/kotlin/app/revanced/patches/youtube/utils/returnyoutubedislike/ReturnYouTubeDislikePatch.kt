...
import app.revanced.patches.youtube.utils.returnyoutubedislike.fingerprints.*
...
object ReturnYouTubeDislikePatch : BytecodePatch(
    ...
    private const val INTEGRATIONS_CLASS_DESCRIPTOR =
        "Lapp/revanced/integrations/youtube/patches/utils/ReturnYouTubeDislikePatch;"
    ...
    override fun execute(context: BytecodeContext) {
        ...
        VideoIdPatch.injectPlayerResponseVideoId("$INTEGRATIONS_CLASS_DESCRIPTOR->preloadVideoId(Ljava/lang/String;Z)V")
        ...
        TextComponentConstructorFingerprint.result?.let { textConstructorResult ->
            ...
            val conversionContextClassType = ConversionContextFingerprint.getResultOrThrow().classDef.type
            ...
            TextComponentLookupFingerprint.getResultOrThrow().mutableMethod.apply {
                // Find the instruction for creating the text data object.
                val textDataClassType = TextComponentDataFingerprint.getResultOrThrow().classDef.type
        ...
        RollingNumberMeasureStaticLabelFingerprint.resolve(context, RollingNumberMeasureStaticLabelParentFingerprint.getResultOrThrow().classDef)
