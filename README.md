...
| `Hook download actions` | Adds options to show the download playlist button and hook the download actions. | 18.29.38 ~ 19.16.39 |
...
| `Enable OPUS codec` | Adds an option to use the OPUS audio codec instead of the MP4A audio codec. | 6.29.58 ~ 7.12.51 |
...
| `Translations` | Adds Crowdin translations for YouTube Music. | 6.29.58 ~ 7.12.51 |
...
| `Visual preferences icons` | Adds icons to specific preferences in the settings. | 6.29.58 ~ 7.12.51 |
</details>
