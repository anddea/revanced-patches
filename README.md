...
| `Enable OPUS codec` | Adds an option to use the OPUS audio codec instead of the MP4A audio codec. | 6.29.58 ~ 7.13.52 |
...
| `Translations` | Adds Crowdin translations for YouTube Music. | 6.29.58 ~ 7.13.52 |
...
| `Visual preferences icons` | Adds icons to specific preferences in the settings. | 6.29.58 ~ 7.13.52 |
</details>
