...
public class SegmentCategoryListPreference extends ListPreference {
    ...
    private boolean isPickerUpdatingText = false;
    private boolean isTextUpdatingPicker = false;
    ...
    protected void showDialog(Bundle state) {
        try {
            ...
            dialogColorPickerView.setInitialColor(categoryColor | 0xFF000000);
            ...
            dialogColorEditText.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable edit) {
                    if (isPickerUpdatingText) return;
                    isTextUpdatingPicker = true;
                    try {
                        ...
                        dialogColorPickerView.setColor(newColor | 0xFF000000);
                    } catch (Exception ex) {
            ...
            dialogOpacityEditText.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable edit) {
                    try {
                        ...
                        final float opacity = opacityStringLength == 0 ? 0 : Float.parseFloat(editString);
                        if (opacity < 0) {
                            categoryOpacity = 0;
            ...
            Pair<Dialog, LinearLayout> dialogPair = Utils.createCustomDialog(
                    ...
                    () -> {
                        ...
                        try {
                            ...
                            dialogColorPickerView.setColor(category.getColorNoOpacityDefault() | 0xFF000000);
            ...
            dialogColorPickerView.setOnColorChangedListener(color -> {
                if (isTextUpdatingPicker) return;

                isPickerUpdatingText = true;
                final int newColor = color & 0x00FFFFFF;

                if (categoryColor == newColor) {
                    isPickerUpdatingText = false;
                    return;
                }
                categoryColor = newColor;
                String hexColor = getColorString(newColor);
