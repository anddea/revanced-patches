...
package app.morphe.patches.youtube.general.dpi
...
private const val EXTENSION_INIT =
    "Lapp/morphe/extension/youtube/dpi/DensityPatch;->init(Landroid/app/Application;)V"
    ...
    execute {
        ...
        traverseClassHierarchy(applicationClass) {
            ...
            onCreate.addInstructions(
                0,
                """
                    invoke-static { p0 }, $EXTENSION_INIT
                """,
            )
            injected = true
        }
